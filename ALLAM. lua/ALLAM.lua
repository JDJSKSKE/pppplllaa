...
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
📮┇ [Source Programmer](https://t.me/FACKYOOOOOU)
...
elseif Text== " علام" then return sendMsg(msg.chat_id_,msg.id_" مبرمج السورس @FACKYOOOOOU")
elseif Text== " علام" then return sendMsg(msg.chat_id_,msg.id_," قلب علام")
